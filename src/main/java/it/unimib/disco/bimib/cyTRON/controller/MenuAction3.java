...
public class MenuAction3 extends AbstractCyAction {
    ...
    public MenuAction3(CyApplicationManager cyApplicationManager, CommandExecutor commandExecutor, final String menuTitle) {
        super("cyTRON");
