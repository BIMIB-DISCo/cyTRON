...
public class RenameDatasetFrame extends javax.swing.JFrame {
    ...
    public RenameDatasetFrame(DatasetController datasetController, int datasetIndex) {
        // get the variables
    ...
    private void initComponents() {
        ...
        renameLabel.setText("Rename Dataset");
    ...
    private void renameButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_renameButtonActionPerformed
        ...
        // rename the dataset
        datasetController.renameDataset(datasetIndex, newName);
